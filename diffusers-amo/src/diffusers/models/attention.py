...
class JointTransformerBlock(nn.Module):
    ...
    def forward(
        self, hidden_states: torch.FloatTensor, encoder_hidden_states: torch.FloatTensor, temb: torch.FloatTensor, return_attn_map: bool = False, txt_loc: tuple = None,
    ):
        ...
        if return_attn_map:
            attn_output, context_attn_output, attn_map = self.attn(
                hidden_states=norm_hidden_states, encoder_hidden_states=norm_encoder_hidden_states, return_attn_map=return_attn_map,
                txt_loc=txt_loc,
            )
        else: 
